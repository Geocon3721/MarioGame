...
function _11map () {
    if (Stop == false) {
        ...
        led.unplot(X + 16, Y + 2)
        led.unplot(X + 16, Y + 3)
        led.plotBrightness(X + 16, Y + 4, 10)
        led.unplot(X + 17, Y - 1)
        led.unplot(X + 17, Y)
        led.unplot(X + 17, Y + 1)
        led.unplot(X + 17, Y + 2)
        ...
        led.unplot(X + 47, Y + 2)
        led.unplot(X + 47, Y + 3)
        led.plotBrightness(X + 47, Y + 4, 10)
        led.unplot(X + 48, Y - 1)
        led.unplot(X + 48, Y)
        led.unplot(X + 48, Y + 1)
        led.unplot(X + 48, Y + 2)
        led.unplot(X + 48, Y + 3)
        led.plotBrightness(X + 48, Y + 4, 10)
        led.unplot(X + 49, Y - 1)
        led.unplot(X + 49, Y)
        led.unplot(X + 49, Y + 1)
        led.unplot(X + 49, Y + 2)
...
basic.forever(function () {
    if (true) {
        if (X - OffSet == -11 && Jump == -4) {
        ...
        } else if (X - OffSet == -3 && Jump == -2 || X - OffSet == -9 && Jump == -2 || X - OffSet == -11 && Jump == -2 || X - OffSet == -13 && Jump == -2 || X - OffSet == -20 && Jump == -2 || X - OffSet == -24 && Jump == -2 || X - OffSet == -38 && Jump == -2 || X - OffSet == -40 && Jump == -2) {
            if (input.isGesture(Gesture.ScreenUp) || input.isGesture(Gesture.Shake)) {
                if (X - OffSet == -11) {
                    CoinBlock11D = CoinBlock11D + 1
                } else {
        ...
        } else if (X - OffSet == -16 && Jump == -1 || X - OffSet == -37 && Jump == -1 || X - OffSet == -41 && Jump == -1) {
            if (input.isGesture(Gesture.ScreenUp) || input.isGesture(Gesture.Shake)) {
                Jump = Jump - 1
                basic.pause(200)
                Jump = Jump - 1
            ...
            basic.pause(200)
            Jump = Jump + 1
        } else if (X - OffSet == -28 && Jump > -1 || X - OffSet == -32 && Jump > -1 || X - OffSet == -33 && Jump > -1 || X - OffSet == -39 && Jump > -1 || X - OffSet == -47 && Jump > -1 || Jump > 0) {
            basic.pause(200)
            Jump = Jump + 1
...
basic.forever(function () {
    if (CoinBlock11B == 0) {
        led.unplot(X + 11, Y + 2)
        basic.pause(100)
        led.plotBrightness(X + 11, Y + 2, 100)
        basic.pause(100)
        led.plotBrightness(X + 11, Y + 2, 100)
        basic.pause(100)
        led.plotBrightness(X + 11, Y + 2, 100)
...
basic.forever(function () {
    if (CoinBlock11E == 0) {
        led.unplot(X + 15, Y + 2)
        basic.pause(100)
        led.plotBrightness(X + 15, Y + 2, 100)
        basic.pause(100)
        led.plotBrightness(X + 15, Y + 2, 100)
        basic.pause(100)
        led.plotBrightness(X + 15, Y + 2, 100)
...
basic.forever(function () {
    ...
    if (Jump < 1) {
        ...
        if (X - OffSet == -17 && Jump == 0 || X - OffSet == -21 && Jump == 0 || X - OffSet == -21 && Jump == -1 || X - OffSet == -25 && Jump == 0 || X - OffSet == -25 && Jump == -1 || X - OffSet == -39 && Jump == -1 || X - OffSet == -39 && Jump == 0 || X - OffSet == -41 && Jump == -1 || X - OffSet == -42 && Jump == 0) {
        } else if (input.buttonIsPressed(Button.A) && OffSet > -2) {
            OffSet = OffSet - 1
            basic.pause(200)
        }
        if (X - OffSet == -15 && Jump == 0 || X - OffSet == -19 && Jump == 0 || X - OffSet == -19 && Jump == -1 || X - OffSet == -23 && Jump == 0 || X - OffSet == -23 && Jump == -1 || X - OffSet == -36 && Jump == 0 || X - OffSet == -37 && Jump == -1 || X - OffSet == -39 && Jump == -1 || X - OffSet == -39 && Jump == 0) {
        } else if (input.buttonIsPressed(Button.B) && OffSet < 0) {
            OffSet = OffSet + 1
            basic.pause(200)
        } else if (input.buttonIsPressed(Button.B) && X > -48) {
        } else if (input.buttonIsPressed(Button.B) && X > -44) {
            X = X - 1
            basic.pause(200)
        }
    }
...
basic.forever(function () {
    if (CoinBlock11E >= 2) {
        led.plotBrightness(X + 15, Y + 2, 10)
...
basic.forever(function () {
    if (true) {
        ...
        } else if (X - OffSet == -3 && Jump == -1 || X - OffSet == -9 && Jump == -1 || X - OffSet == -11 && Jump == -1 || X - OffSet == -13 && Jump == -1 || X - OffSet == -20 && Jump == -1 || X - OffSet == -24 && Jump == -1 || X - OffSet == -38 && Jump == -1 || X - OffSet == -40 && Jump == -1 || X - OffSet == -44 && Jump == -1) {
            Jump = -2
        } else if (Jump == 0) {
            if (X - OffSet == -16 || X - OffSet == -37 || X - OffSet == -41 || X - OffSet == -50) {
                Jump = -1
            } else if (X - OffSet == -20 || X - OffSet == -24 || X - OffSet == -38 || X - OffSet == -40 || X - OffSet == -51) {
                Jump = -2
            }
        }
    }
